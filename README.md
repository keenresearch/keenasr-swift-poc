...
A proof-of-concept app that shows how to run KeenASR automatic speech recognition framework in a Swift app. For detailed information on all classes and methods, consult the [SDK reference documentation](http://keenresearch.com/keenasr-docs) (Swift documentation coming soon). If starting with the framework from scratch, check our [Quick Start](https://keenresearch.com/keenasr-docs/keenasr-ios-quick-start.html) document.

This demo app uses acoustic models in `keenA1m-nnet3chain-en-us` directory. Keen Research provides a number of custom acoustic models to its clients.
